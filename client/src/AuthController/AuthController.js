    ...
    render() {
        return (
            <div>
                ...
                <RegisterDialog isOpen={this.state.isRegisterOpened} closeHandler={() => {this.setState({isRegisterOpened: false})}}/>
                <LoginDialog isOpen={this.state.isLoginOpened} closeHandler={() => {this.setState({isLoginOpened: false})}}/>
            </div>
        );
    }
}
